             ...
             <div class="flex items-center space-x-2">
                 <div class="flex items-center">
                     ...
                     <select id="perPageSelect"
                         ...
                         <option value="10" {{ $exams->perPage() == 10 ? 'selected' : '' }}>10</option>
                         <option value="15" {{ $exams->perPage() == 15 ? 'selected' : '' }}>15</option>
                         <option value="20" {{ $exams->perPage() == 20 ? 'selected' : '' }}>20</option>
                         <option value="25" {{ $exams->perPage() == 25 ? 'selected' : '' }}>25</option>
                     </select>
                 </div>

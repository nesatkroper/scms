...
<div id="deleteStudentModal" class="fixed inset-0 z-50 flex items-center justify-center p-4 hidden">
    <div
        ...
        <div class="flex justify-between items-center p-4 border-b border-gray-200 dark:border-gray-700">
            <h3 class="text-xl font-bold text-gray-800 dark:text-gray-200 flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg"
                    class="h-5 w-5 p-1 rounded-full bg-red-50 text-red-600 dark:text-red-50 dark:bg-red-900"
            ...
            <button id="closeDeleteStudentModal"
        ...
        <div class="flex justify-end space-x-3 p-4 border-t border-gray-200 dark:border-gray-700">
            <button type="button" id="cancelDeleteStudentModal"

@if (count($teachers) > 0)
    @foreach ($teachers as $teacher)
        <div
            class="bg-white dark:bg-slate-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 overflow-hidden transition-all hover:shadow-lg">
            <div class="p-4">
                <div class="flex justify-between items-start">
                    <div>
                        <h4 class="font-bold text-lg text-gray-800 dark:text-gray-200">{{ $teacher->user->name }}</h4>
                        <span class="text-sm text-indigo-600 dark:text-indigo-400">{{ $teacher->teacher_id }}</span>
                    </div>
                ...
                <div class="mt-3 text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <div class="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span>{{ Str::limit($teacher->qualification, 25) }}</span>
                        </div>
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span>{{ Str::limit($teacher->specialization, 25) }}</span>
                        </div>
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span>{{ \Carbon\Carbon::parse($teacher->joining_date)->format('Y-m-d') }}</span>
                        </div>
                    </div>
                </div>

...
<div id="Modalcreate" class="fixed inset-0 z-50 flex items-center justify-center p-4 hidden">
    <div class="relative bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-2xl transform transition-all duration-300 opacity-0 scale-95 border border-white dark:border-gray-600">
        ...
        <!-- Form Content -->
        <form action="{{ route('sections.store') }}" method="POST" class="p-4">
            @csrf
            ...
            <div class="h-[65vh] md:h-auto">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-1 sm:gap-4 mb-2">
                    ...
                    <div class="mb-2">
                        ...
                        <div data-name="grade_level_id" class="custom-select relative w-full px-3 py-2 border rounded-md focus:outline focus:outline-white
                        focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white
                        @error('grade_level_id') border-red-500 @else border-gray-400 @enderror">
                            ...
                            <div class="select-options absolute z-10 top-full left-0 right-0 max-h-[250px] overflow-y-auto hidden shadow-md rounded-sm bg-slate-50 dark:bg-slate-700 border border-slate-300 dark:border-slate-600">
                                <div class="search-container p-2 sticky top-0 z-1 bg-white dark:bg-slate-700">
                                    ...
                                    focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 bg-gray-100 dark:bg-gray-700 dark:border-gray-600 dark:text-white" placeholder="Search grade level...">
                                </div>
                    ...
                    <div class="mb-2">
                        ...
                        <div data-name="teacher_id" class="custom-select relative w-full px-3 py-2 border rounded-md focus:outline focus:outline-white
                        focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white
                        @error('teacher_id') border-red-500 @else border-gray-400 @enderror">
                            ...
                            <div class="select-options absolute z-10 top-full left-0 right-0 max-h-[250px] overflow-y-auto hidden shadow-md rounded-sm bg-slate-50 dark:bg-slate-700 border border-slate-300 dark:border-slate-600">
                                <div class="search-container p-2 sticky top-0 z-1 bg-white dark:bg-slate-700">
                                    <input type="search" class="search-input text-sm w-full px-3 py-2 border rounded-md focus:outline focus:outline-white
                                    focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 bg-gray-100 dark:bg-gray-700 dark:border-gray-600 dark:text-white" placeholder="Search teacher...">
                                </div>
                                <div class="options-container">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="number" min="1" id="capacity"
                            name="capacity" value="{{ old('capacity', 30) }}"
                            class="w-full px-3 py-2 border rounded-md focus:outline focus:outline-white
                        focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white

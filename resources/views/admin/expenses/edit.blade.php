    ...
    <form action="{{ route('admin.expenses.update', $expense->id) }}" method="POST" id="editForm" class="p-0">
      ...
      <div class="flex justify-end space-x-3 pt-4 border-t border-gray-200 dark:border-gray-700">
        ...
        @if (Auth::user()->hasPermissionTo('update_expense'))
          <button type="submit"
            class="p-2 cursor-pointer bg-red-600 text-white rounded-lg hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 flex items-center gap-2 transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
              <path

...
">
                    ...
                    <div class="p-4 space-y-3 flex-grow">
                        ...
                        @if ($user->hasRole('teacher'))
                            <x-info.item
                                name="{{ $user->qualification ?? 'Not Specified' }} | {{ $user->specialization ?? 'N/A' }}"
        ...
        <div x-show="showPasswordModal" x-cloak x-transition.opacity
            ...
            <div x-transition.scale
               ...
               dark:border-gray-700/40 relative">
                <!-- Header -->
        ...
        <div x-show="showRoleModal" x-cloak x-transition.opacity
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-xl">
                <!-- Header -->
                <div
                    class="bg-gradient-to-r from-indigo-500 to-purple-600 p-4 py-2 text-white rounded-[1px_12px_0px_12px]">
                        ...
                        <div class="mb-4 flex justify-between items-center">
                            ...
                            <div class="flex items-center justify-between">
                                <span class="text-sm text-gray-500 dark:text-gray-400">
                                    Selected:
                                    <span x-text="selectedRoles.length"
                                    ...
                                    group-hover:shadow-md ">
                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            {{ !in_array($role->name, ['admin', 'teacher', 'student']) ? 'fa-user-gear text-gray-500' : '' }}">
                                                ...
                                                <div>
                                                    <span
                                                        class="font-semibold text-gray-900 dark:text-white capitalize block">
                                                        {{ $role->name }}
                                                    </span>

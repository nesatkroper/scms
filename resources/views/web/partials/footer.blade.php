<!-- Footer -->
<footer class="footer-gradient text-white pt-16 pb-8 dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-800">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-6">
            ...
            <div class="space-y-4">
                ...
                <p class="text-blue-100 dark:text-slate-200 mb-0 leading-relaxed">
                    Providing quality education and nurturing young minds since 2005.
                    Empowering students to achieve their full potential.
                </p>
                <div class="pt-2">
                    <h4 class="font-medium text-slate-200 dark:text-slate-100 mb-2">Follow Us</h4>
                    <div class="flex space-x-3">
                        <a href="#"
                            class="w-9 h-9 rounded-full bg-blue-800 dark:bg-blue-900 flex items-center justify-center hover:bg-blue-700 dark:hover:bg-blue-600 transition-all duration-300 transform hover:-translate-y-1 hover:scale-110">
            ...
            <!-- Quick Links -->
            <div>
                <h3 class="text-xl font-bold mb-6 relative pb-2 text-white dark:text-blue-100">
                    Quick Links
                    <span
                        class="absolute bottom-0 left-0 w-12 h-1 bg-gradient-to-r from-blue-400 to-indigo-500 rounded-full"></span>
                </h3>
                <ul class="space-y-4">
                    <li>
                        <a href="#home"
        ...
        <div class="pt-8 border-t border-blue-700/50 dark:border-slate-600/50">
            <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                ...
                <div class="flex space-x-6">
                    <a href="#"
                        class="text-slate-200 dark:text-slate-100 hover:text-white dark:hover:text-blue-100 transition-colors duration-300 text-sm">
                        Privacy Policy
                    </a>
                    <a href="#"
                        class="text-slate-200 dark:text-slate-100 hover:text-white dark:hover:text-blue-100 transition-colors duration-300 text-sm">

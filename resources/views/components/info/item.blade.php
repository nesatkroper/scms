@php
  ...
  $iconWrapperClasses =
      'p-1 rounded-lg border border-gray-200 dark:border-slate-700 text-indigo-600 dark:text-indigo-400';
...
<div class="{{ $containerClasses }}">
  ...
  <div class="{{ $textWrapperClasses }}">
    ...
    <span id="{{ $id }}"
      class="text-xs truncate font-bold text-start {{ $color }}">{{ $name }}</span>
  </div>
</div>

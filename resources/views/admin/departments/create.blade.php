<x-modal.modal id="Modalcreate" title="Create New department" class="rounded-xl w-full max-w-md"
    svgPath="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z">
    <form action="{{ route('admin.departments.store') }}" method="POST" class="p-4 needs-validation" novalidate>
        @csrf

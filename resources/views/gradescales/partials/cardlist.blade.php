    ...
    @foreach ($gradeScales as $gradeScale)
        <div
                ...
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <div class="flex gap-2 mt-1">
                            ...
                            <span
                                class="inline-block px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200">
            ...
            <div class="p-4">
                <div class="space-y-3">
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-2">
                            <p class="text-xs text-gray-500 dark:text-gray-400">Percentage Range</p>
                            <p class="text-sm font-medium text-gray-700 dark:text-gray-200">
                                {{ $gradeScale->min_percentage }}% to {{ $gradeScale->max_percentage }}%
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-2">
                            <p class="text-xs text-gray-500 dark:text-gray-400">GPA Value</p>
                            <p class="text-sm font-medium text-gray-700 dark:text-gray-200">
                                {{ $gradeScale->gpa }}
                            </p>
                        </div>
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-300 line-clamp-3">
                            {{ $gradeScale->description ?? 'No description available' }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div
                ...
                <button
                    class="edit-btn cursor-pointer px-3 py-1.5 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-md transition-colors flex items-center"
                    data-id="{{ $gradeScale->id }}">
...
@else
    <div class="col-span-full py-12 text-center">
        <div
            ...
            <h3 class="mt-4 text-lg font-medium text-red-500 dark:text-red-500">No Grade Scales Found</h3>
            <p class="mt-2 text-sm text-red-500 dark:text-red-500">Create your first grade scale to get started</p>
        </div>
    </div>
@endif

...
@section('content')
  ...
  <div
    ...
    <h3 class="text-lg mb-3 font-bold text-gray-800 dark:text-gray-200 flex items-center gap-2">
      {{-- Icon for Expense Categories (using a tag/label theme) --}}
      ...
      @empty
        <div class="col-span-full py-12 text-center">
          <div
            ...
            <h3 class="mt-4 text-lg font-medium text-red-500 dark:text-red-500">No Expense Categories Found</h3>
            <p class="mt-1 text-sm text-red-500 dark:text-red-500">Create your first expense category to get started</p>
          </div>
        </div>
      @endforelse
    </div>

...
<div id="bulkDeleteToastModal" class="fixed inset-0 z-50 flex items-center justify-center p-4 hidden">
  <div
    ...
    <div class="p-6 text-center">
      <svg class="mx-auto h-12 w-12 text-red-500 dark:text-red-400" fill="none" stroke="currentColor"
        viewBox="0 0 24 24">
      ...
      <div class="mt-2 text-sm text-gray-500 dark:text-gray-300">
        <p>Are you sure you want to delete <span id="selectedCountText" class="font-semibold">0</span> selected
          departments?</p>
      </div>

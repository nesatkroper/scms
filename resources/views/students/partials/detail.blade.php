...
<div id="detailStudentModal" class="fixed inset-0 z-50 flex items-center justify-center p-4 hidden">
    <div
        ...
        <div class="flex justify-between items-center p-4 border-b border-gray-200 dark:border-gray-700">
            ...
            <button id="closeDetailStudentModal"
        ...
        <div class="p-4 px-6">
            <div class="mb-4">
                <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400">First Name</h4>
                <p id="detail_first_name" class="mt-1 text-sm text-gray-900 dark:text-gray-200"></p>
            </div>

            <div class="mb-4">
                <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400">Last Name</h4>
                <p id="detail_last_name" class="mt-1 text-sm text-gray-900 dark:text-gray-200"></p>
            </div>

            <div class="mb-4">
                <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400">Email</h4>
                <p id="detail_email" class="mt-1 text-sm text-gray-900 dark:text-gray-200"></p>
            </div>

            <div class="mb-4">
                <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400">Gender</h4>
                <p id="detail_gender" class="mt-1 text-sm text-gray-900 dark:text-gray-200"></p>
            </div>

            <div class="mb-4">
                <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400">Date of Birth</h4>
                <p id="detail_dob" class="mt-1 text-sm text-gray-900 dark:text-gray-200"></p>
            </div>

            <div class="mb-4">
                <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400">Admission Date</h4>
                <p id="detail_admission_date" class="mt-1 text-sm text-gray-900 dark:text-gray-200"></p>
            </div>
        ...
        <div class="flex justify-end space-x-3 p-4 border-t border-gray-200 dark:border-gray-700">
            <button type="button" id="closeDetailStudentModalBtn"

...
class StoreTeacherRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'phone.regex' => 'Please enter a valid Cambodian phone number (e.g., 012 345 678 or +855 12 345 678).',
            ...
            'experience.max' => 'Experience seems too high. Please enter the number of years, not the starting year.',

<table>
  <thead>
    <tr>
      <th colspan="8" style="text-align: center; font-weight: bold; font-size: 16pt; background-color: #ef4444; color: #ffffff;">{{ strtoupper($title ?? 'STUDENT ENROLLMENT REPORT') }}</th>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <th style="border: 1px solid #000000; background-color: #f3f4f6; font-weight: bold; width: 200px;">COURSE / SUBJECT</th>
      ...
      <th style="border: 1px solid #000000; background-color: #f3f4f6; font-weight: bold; width: 120px; text-align: center;">PAYMENT</th>
  ...
  <tbody>
    @foreach ($data as $enrollment)
      <tr>
        ...
        <td style="border: 1px solid #000000; font-weight: bold;">{{ strtoupper($enrollment->student->name) }}</td>

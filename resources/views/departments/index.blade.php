...
@push('scripts')
    <script>
        ...
        function initializeActionButtons() {
            // Reinitialize all your button event listeners here
            // (Copy all your existing button event listeners from the DOMContentLoaded function)

            // Example for edit buttons:
            $('.edit-btn').off('click').on('click', function(e) {
                // Your existing edit button code

            });

            // Do the same for detail, delete, etc. buttons
        }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.btn-action').forEach(button => {
                button.addEventListener('click', function(e) {
                    ...
                    const dropdown = document.getElementById(`dropdown-${departmentId}`);

                    // Close all other dropdowns first
                    document.querySelectorAll('[id^="dropdown-"]').forEach(d => {
                        if (d.id !== `dropdown-${departmentId}`) {
            ...
            document.addEventListener('keydown', function(e) {
                if (e.key === 'Escape') {
                    if (!document.getElementById('createDepartmentModal').classList.contains('hidden')) {
                        closeCreateModal();

            ...
            <div class="h-[65vh] md:h-auto">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-1 sm:gap-4 mb-2">
                 ...
                 focus:outline-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700
                        ...
                        @error('subject_id') border-red-500 @else border-gray-400 @enderror">
                            ...
                            @foreach ($subjects as $subject)
                                <option value="{{ $subject->id }}"
                                    data-subject="{{ old('subject_id') == $subject->id ? 'selected' : '' }}"
                                    {{ old('subject_id') == $subject->id ? 'selected' : '' }} selected>
                                    {{ $subject->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <!-- total_marks Field -->
                    <div class="mb-2">
                        <label for="edit_total_marks"
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                            Total Marks <span class="text-red-500">*</span>
                        </label>
                        <input type="number" min="1" id="edit_total_marks" name="total_marks"
                            class="w-full px-3 py-2 border rounded-md focus:outline
                 focus:outline-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700
                      dark:text-white focus:bg-slate-100 dark:focus:bg-slate-700 border-slate-300"
                    ...
                    <div class="mb-2">
                        <label for="edit_passing_marks"
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                            Passing Marks <span class="text-red-500">*</span>
                        </label>
                        <input type="number" min="0" id="edit_passing_marks" name="passing_marks"

                        ...
                        <div class="relative">
                            ...
                            <div class="dropdown-menu hidden absolute w-auto right-0 z-10 mt-2 origin-top-right divide-y divide-gray-100 dark:divide-gray-700 rounded-md bg-white dark:bg-gray-800 shadow-lg ring-1 ring-black/5 dark:ring-gray-700 focus:outline-none"
                                ...
                                <div class="py-1" role="none">
                                    <a href="#" title="Edit Id({{ $section->id }})"
                                    ...
                                    <a href="#" title="Details Id({{ $section->id }})"
                                    ...
                                    <button href="#" title="Delete Id({{ $section->id }})"
                ...
                <td colspan="8" class="p-4 text-center">
                    <div class="col-span-full py-12 text-center">
                        <div
                            ...
                            <p class="mt-2 text-sm text-red-500 dark:text-red-500">Create your first section to get started</p>
                        </div>
                    </div>
                </td>
            </tr>
...
<div id="bulkActionsBar"
    ...
    <div class="flex flex-col items-start gap-1">
        ...
        <div class="text-sm text-gray-700 dark:text-gray-300">
            <span id="selectedCount">0</span> sections selected
        </div>

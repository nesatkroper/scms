    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function handleEditClick(e) {
                ...
                $.get(`/expenses/${Id}`)
                    .done(function(response) {
                        if (response.success) {
                            $('#edit_title').val(response.expenses.title);
                            $('#edit_code').val(response.expenses.code);
                            $('#edit_description').val(response.expenses.description);
            ...
            function handleDetailClick(e) {
                ...
                $.get(`/expenses/${Id}`)
                    .done(function(response) {
                        if (response.success) {detail_description

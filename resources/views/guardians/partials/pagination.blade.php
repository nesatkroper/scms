        ...
        <div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
            <div>
                <p class="text-sm text-gray-700 dark:text-gray-300">
                    Showing
                    <span class="font-medium">{{ $guardians->firstItem() }}</span>
                    to
                    <span class="font-medium">{{ $guardians->lastItem() }}</span>
                    of
                    <span class="font-medium">{{ $guardians->total() }}</span>
                    guardians
                </p>
            </div>
            <div class="flex items-center space-x-2">
                <div class="flex items-center">
                    ...
                    <select id="perPageSelect"
                        ...
                        <option value="10" {{ $guardians->perPage() == 10 ? 'selected' : '' }}>10</option>
                        <option value="15" {{ $guardians->perPage() == 15 ? 'selected' : '' }}>15</option>
                        <option value="20" {{ $guardians->perPage() == 20 ? 'selected' : '' }}>20</option>
                        <option value="25" {{ $guardians->perPage() == 25 ? 'selected' : '' }}>25</option>
                    </select>
                </div>

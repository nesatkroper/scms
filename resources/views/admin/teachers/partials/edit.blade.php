<!-- {{ __('message.edit') }} Modal -->
<x-modal.modal id="Modaledit" title="{{ __('message.edit') }} Teacher Profile" svgClass="rounded-md" fill="none"
  stroke="currentColor" viewBox="0 0 24 24" class="rounded-xl w-full max-w-2xl"
      ...
      <div class="pt-16 px-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-2 mb-2">
          ...
          <x-fields.input :edit="true" type="text" min="0" max="60" maxlength="2"
            label="Experience" name="experience" placeholder="Enter number 0-60" pattern="^([0-9]|[1-5][0-9]|60)$"
          ...
          <x-fields.input :edit="true" type="email" label="Email" name="email"
            placeholder="Enter email: example@gmail.com" required maxlength="255" />

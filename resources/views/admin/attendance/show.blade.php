  ...
  <div
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-2">
      @forelse ($attendances as $attendance)
        @php
          $statusClasses = [
              'present' => 'bg-green-50 text-green-800 dark:bg-green-900/50 dark:text-green-300',
              'absent' => 'bg-red-50 text-red-800 dark:bg-red-900/50 dark:text-red-300',
              'late' => 'bg-yellow-50 text-yellow-800 dark:bg-yellow-900/50 dark:text-yellow-300',
              'excused' => 'bg-blue-50 text-blue-800 dark:bg-blue-900/50 dark:text-blue-300',
          ];
          $statusColor =

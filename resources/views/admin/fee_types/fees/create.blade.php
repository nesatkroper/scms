      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-4">
        ...
        <div>
          ...
          <div class="relative">
            ...
            <input type="text" id="due_date" name="due_date" datepicker datepicker-format="yyyy-mm-dd"
              value="{{ old('due_date', now()->addDays(7)->toDateString()) }}" placeholder="Select due date"
              class="block w-full ps-10 pe-3 py-2 border rounded-lg focus:outline focus:outline-white
                         focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700
                         dark:border-gray-600 dark:text-white focus:bg-slate-100 dark:focus:bg-slate-700 border-slate-300

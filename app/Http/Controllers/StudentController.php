...
{
    $students = Student::with('user', 'section')->paginate(10);
    $users = User::all();       // needed for user dropdown in create modal
    $sections = Section::all(); // needed for section dropdown in create modal
    ...
    public function edit(Student $student)
    {
        $users = User::all();
        $sections = Section::all();
        return view('students.edit', compact('student', 'users', 'sections'));
    }

      ...
      <div class="mb-4 p-3 border rounded-lg border-gray-300 dark:border-gray-700 bg-violet-50 dark:bg-slate-800/50">
        ...
        <div class="flex items-center gap-2 mb-4">
          ...
          <button id="resetSearch" type="button"
            class="p-2 h-8 w-8 flex items-center justify-center cursor-pointer bg-indigo-100 dark:bg-indigo-700 hover:bg-gray-300 dark:hover:bg-indigo-600 rounded-full transition-colors"
            title="Reset Search">

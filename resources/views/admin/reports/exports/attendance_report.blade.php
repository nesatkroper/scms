  ...
  <thead>
    <tr>
      <th colspan="5"
        ...
        {{ strtoupper($title ?? 'ATTENDANCE REPORT') }}</th>
    </tr>
    <tr>
      <th colspan="5" style="text-align: center; color: #6b7280; font-size: 10pt;">Period:
    ...
    <tr>
      ...
      <th style="border: 1px solid #000000; background-color: #f3f4f6; font-weight: bold; width: 400px;">COURSE / SUBJECT
      </th>

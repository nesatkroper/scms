...
@section('content')
  ...
  <x-page.alert />
  <x-page.index :canCreate="false" :btnLink="true" :showSearch="true" :showReset="true" :showViewToggle="false"
    title="Roles" iconSvgPath="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" btn-text="Create new role">

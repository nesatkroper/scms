    <div class="box grid sm:grid-cols-2 grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-4 mb-4">
      <!-- Fees Collected -->
      <div
        class="bg-white dark:bg-gray-800 dark:hover:bg-amber-950 rounded-[2rem] p-5 border border-gray-200
      ...
      <!-- Active Classes -->
      <div
        class="bg-white dark:bg-gray-800 dark:hover:bg-green-950 rounded-[2rem] p-5 border border-gray-200
             dark:border-gray-700 shadow-sm relative">
        <div class="flex justify-between">
          <div>

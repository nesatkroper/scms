...
@section('content')
  ...
  <div
    ...
    {{-- The form will handle file uploads (avatar) --}}
    <form action="{{ route('admin.students.store') }}" method="POST" enctype="multipart/form-data" id="createForm"
      class="p-0">
      @csrf
      ...
      {{-- REMOVED PASSWORD INPUTS SECTION --}}
      <p class="text-sm text-gray-500 dark:text-gray-400 mb-6 border-t pt-4 border-gray-200 dark:border-gray-700">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        ...
        <div>
          ...
          <input type="text" id="blood_group" name="blood_group" value="{{ old('blood_group') }}" maxlength="5"
        ...
        <div>
          ...
          <input type="text" id="nationality" name="nationality" value="{{ old('nationality') }}" maxlength="50"
        ...
        <div>
          ...
          <input type="text" id="religion" name="religion" value="{{ old('religion') }}" maxlength="50"
        ...
        <div>
          ...
          <input type="text" id="occupation" name="occupation" value="{{ old('occupation') }}" maxlength="100"
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
        ...
        <div>
          ...
          <input type="text" id="company" name="company" value="{{ old('company') }}" maxlength="100"
        ...
        <div class="sm:col-span-2">
          ...
          <textarea id="address" name="address" rows="3" maxlength="500"
            class="w-full px-3 py-2 border rounded-md focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white border-slate-300 @error('address') border-red-500 @enderror">{{ old('address') }}</textarea>
          @error('address')
            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
          @enderror
        </div>

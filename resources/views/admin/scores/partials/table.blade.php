        ...
        @if (count($scores) > 0)
            @foreach ($scores as $score)
                <tr
                    ...
                    <td class="px-4 py-2">{{ $score->student->name ?? 'N/A' }}</td>
                    <td class="px-4 py-2">{{ $score->exam->name ?? 'N/A' }}</td>
                    <td class="px-4 py-2">{{ $score->subject->name ?? 'N/A' }}</td>
                    <td class="px-4 py-2">{{ $score->semester ?? 'N/A' }}</td>
                    <td class="px-4 py-2">{{ $score->score }}</td>
                    <td class="px-4 py-2">{{ $score->grade }}</td>
                    <td class="px-4 py-2">{{ Str::limit($score->remarks, 20) }}</td>
                    <td class="px-4 py-2">
                        ...
                        <div class="relative">
                            ...
                            <div class="dropdown-menu hidden absolute w-auto right-0 z-10 mt-2 origin-top-right divide-y divide-gray-100 dark:divide-gray-700 rounded-md bg-white dark:bg-gray-800 shadow-lg ring-1 ring-black/5 dark:ring-gray-700 focus:outline-none"
                                ...
                                <div class="py-1" role="none">
                                    ...
                                    <a href="#" title="Details Id({{ $score->id }})"
                                    ...
                                    <button href="#" title="Delete Id({{ $score->id }})"
                    ...
                    <td class="px-2 py-2">
                        <input type="checkbox" name="selected_ids[]" value="{{ $score->id }}"
                ...
                <td colspan="12" class="p-4 text-center">
                    <div class="col-span-full py-12 text-center">
                        <div
                            ...
                            <p class="mt-2 text-sm text-red-500 dark:text-red-500">Create your first score record to
                                get
                                started
                            </p>
                        </div>

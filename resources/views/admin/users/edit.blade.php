        ...
        <form id="Formedit" action="{{ route('admin.users.update', $user) }}" method="POST"
            ...
            <div class="space-y-6">
                <div class="relative h-28 flex items-end justify-center bg-gray-50 dark:bg-gray-700 rounded-t-lg">
                     <x-photos.upload2 name="avatar" size="xl" :current-image-url="$user->avatar ? asset($user->avatar) : null" :can-remove="true"
                            :remove-action="'$parent.clearAvatar()'" />
                </div>
              ...
              @enderror
                        ...
                        <div class="mb-2">
                            ...
                            <input type="number" id="experience" name="experience" placeholder="e.g., 5"
                                min="0" step="0.5" value="{{ old('experience', $user->experience) }}"
                        ...
                        <div class="mb-2">
                            ...
                            <input type="number" id="salary" name="salary" placeholder="Enter salary amount"
                                min="0" step="0.01" value="{{ old('salary', $user->salary) }}"

...
return new class extends Migration
{
  public function up(): void
  {
    ...
    Schema::create('users', function (Blueprint $table) {
      ...
      $table->enum('gender', ['monk', 'male', 'female', 'other'])->nullable()->default('male');
    ...
    Schema::create('course_offerings', function (Blueprint $table) {
      ...
      $table->unique(['teacher_id', 'schedule', 'time_slot'], 'unique_teacher_schedule_slot');
      $table->unique(['classroom_id', 'schedule', 'time_slot'], 'unique_classroom_schedule_slot');
    });
    ...
    Schema::create('enrollments', function (Blueprint $table) {
      ...
      $table->unique(['student_id', 'course_offering_id'], 'unique_student_course_enrollment');
    });
    ...
    Schema::create('exams', function (Blueprint $table) {
      $table->uuid('id')->primary();
      $table->uuid('course_offering_id');
      $table->enum('type', ['midterm', 'final', 'speaking', 'listening', 'reading', 'writing']);
      $table->text('description')->nullable();
      $table->date('date');
      ...
      $table->unique(['course_offering_id', 'type'], 'unique_exam_type_per_course');
    });
    ...
    Schema::create('fees', function (Blueprint $table) {
      ...
      $table->unique(['enrollment_id', 'fee_type_id'], 'unique_fee_per_enrollment_type');
    });
    ...
    Schema::create('scores', function (Blueprint $table) {
      ...
      $table->unique(['student_id', 'exam_id'], 'unique_student_exam_score');
    });

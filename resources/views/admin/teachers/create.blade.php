      ...
      <div class="space-y-6">
        ...
        <div class="pt-5 pb-4 border-b border-slate-300 dark:border-slate-700">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-2 gap-x-6">
            ...
            <div class="mb-2">
              ...
              <div class="relative">
                ...
                <input type="text" id="date_of_birth" name="date_of_birth" datepicker datepicker-format="yyyy-mm-dd"
                  placeholder="Enter Date of Birth" required value="{{ old('date_of_birth') }}" class="block w-full ps-9 pe-3 py-2.5
            ...
            <div class="mb-2 col-span-1 md:col-span-2 lg:col-span-3">
              ...
              <textarea id="address" name="address" placeholder="Enter full address" rows="2" required class="form-control w-full p-2 border px-4 rounded-lg focus:outline focus:outline-white
                         focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700
                         dark:border-gray-600 dark:text-white focus:bg-slate-100 dark:focus:bg-slate-700
          ...
          <div class="grid grid-cols-1 md::grid-cols-2 lg:grid-cols-3 gap-y-2 gap-x-6">
            ...
            <div class="mb-2">
              ...
              <div class="relative">
                ...
                <input type="text" id="joining_date" name="joining_date" datepicker datepicker-format="yyyy-mm-dd"
                  placeholder="Enter Joining Date" required value="{{ old('joining_date') }}" class="block w-full ps-9 pe-3 py-2.5
               bg-neutral-secondary-medium border border-default-medium
               text-heading text-sm rounded-base
               focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500
               shadow-xs placeholder:text-body
            ...
            <div class="mb-2">
              ...
              <input type="text" id="qualification" name="qualification" placeholder="e.g. Master in Science" required
                value="{{ old('qualification') }}" class="form-control w-full p-2 border px-4 rounded-lg focus:outline focus:outline-white
                         focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700
                         dark:border-gray-600 dark:text-white focus:bg-slate-100 dark:focus:bg-slate-700
            ...
            <div class="mb-2">
              ...
              <input type="number" id="experience" name="experience" placeholder="e.g., 5" required
                value="{{ old('experience') }}" min="0" x-on:input="
            ...
            <div class="mb-2">
              ...
              <input type="text" id="specialization" name="specialization" placeholder="e.g. Mathematics"
                value="{{ old('specialization') }}" class="form-control w-full p-2 border px-4 rounded-lg focus:outline focus:outline-white
                         focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700
                         dark:border-gray-600 dark:text-white focus:bg-slate-100 dark:focus:bg-slate-700
            ...
            <div class="mb-2">
              ...
              <input type="number" id="salary" name="salary" placeholder="0.00" step="0.01" value="{{ old('salary') }}"
                class="form-control w-full p-2 border px-4 rounded-lg focus:outline focus:outline-white
                         focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700
                         dark:border-gray-600 dark:text-white focus:bg-slate-100 dark:focus:bg-slate-700
        ...
        <div class="pt-4 border-t border-gray-200 dark:border-gray-700">
          <p class="text-sm text-gray-500 dark:text-gray-400">
            Note: The password for the new teacher will be automatically set to <code

...
@section('content')
  ...
  <div
    ...
    {{-- Form action updated to the department update route and includes @method('PUT') --}}
    <form action="{{ route('admin.departments.update', $department->id) }}" method="POST" id="editForm" class="p-0">
      @csrf
      @method('PUT') {{-- Required for update method --}}

      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">

        {{-- Department Name Field (Pre-filled with existing data) --}}
      ...
      {{-- Department Description Field (Pre-filled with existing data) --}}
      <div class="mb-6">
        ...
        <textarea id="description" name="description" rows="3"
          ...
          placeholder="Enter department description">{{ old('description', $department->description) }}</textarea> {{-- Pre-fill logic --}}
      ...
      <div class="flex justify-end space-x-3 pt-4 border-t border-gray-200 dark:border-gray-700">
        ...
        {{-- Submit button text updated to 'Update' --}}
        <button type="submit"

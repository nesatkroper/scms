...
<div id="Modaldelete" class="fixed inset-0 z-50 flex items-center justify-center p-4 hidden">
    <div
        ...
        <div class="flex justify-between items-center p-4 border-b border-gray-200 dark:border-gray-700">
            <h3 class="text-xl font-bold text-gray-800 dark:text-gray-200 flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg"
                    class="h-5 w-size-8 p-1 rounded-full bg-red-50 text-red-600 dark:text-red-50 dark:bg-red-900"
        ...
        <!-- Content -->
        <div class="p-6">
            <p class="text-gray-700 dark:text-gray-300">Are you sure you want to delete this student? This will also remove all associated data and cannot be undone.</p>
            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Student ID: <span id="deleteStudentId" class="font-medium"></span></p>
        </div>

         ...
         <div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
             <div>
                 <p class="text-sm text-gray-700 dark:text-gray-300">
                     Showing
                     <span class="font-medium">{{ $subjects->firstItem() }}</span>
                     to
                     <span class="font-medium">{{ $subjects->lastItem() }}</span>
                     of
                     <span class="font-medium">{{ $subjects->total() }}</span>
                     results
                 </p>
             </div>
             <div class="flex items-center space-x-2">
                 <div class="flex items-center">
                     ...
                     <select id="perPageSelect"
                         ...
                         <option value="15" {{ $subjects->perPage() == 15 ? 'selected' : '' }}>15</option>
                         <option value="20" {{ $subjects->perPage() == 20 ? 'selected' : '' }}>20</option>

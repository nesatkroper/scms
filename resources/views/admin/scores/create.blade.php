...
@section('content')
  <div class="p-4">
    <div class="max-w-3xl mx-auto bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 sm:p-8">
      <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-6 text-center">Create New Score</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="col-span-full">
            ...
            <textarea name="remarks" id="remarks" rows="3"
              class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-700 dark:text-gray-200">{{ old('remarks') }}</textarea>
            @error('remarks')
              <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
            @enderror
          </div>

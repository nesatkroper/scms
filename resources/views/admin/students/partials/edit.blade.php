    ...
    <form id="Formedit" method="POST" class="overflow-y-auto max-h-[80vh] needs-validation" novalidate
        ...
        <div class="pt-16 pb-4 px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-2">
                ...
                <x-fields.input :edit="true" label="Name" name="name" placeholder="Enter student name" :required="true" />
                
                <x-fields.input :edit="true" type="email" label="Email" name="email" placeholder="Enter email" :required="true" />
                
                <x-fields.input :edit="true" label="Phone" name="phone" placeholder="Enter phone number" :required="true" />
                
                <x-fields.input :edit="true" type="date" label="Date of Birth" name="dob" :required="true" />

                <x-fields.select :edit="true" label="Gender" name="gender" :options="['male'=>'Male','female'=>'Female','other'=>'Other']" :required="true" />

                <x-fields.select :edit="true" label="Grade Level" name="grade_level_id" :options="$gradeLevels->pluck('name','id')" :required="true" />
                ...
                <x-fields.input :edit="true" type="date" label="Admission Date" name="admission_date" :required="true" />

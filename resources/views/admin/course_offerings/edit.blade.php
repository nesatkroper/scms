    ...
    <form action="{{ route('admin.course_offerings.update', $courseOffering->id) }}" method="POST" id="editForm"
        ...
        <div>
          ...
          <select id="teacher_id" name="teacher_id" required
            ...
            @foreach ($teachers as $teacher)
              <option value="{{ $teacher->id }}" @selected(old('teacher_id', $courseOffering->teacher_id) == $teacher->id)>{{ $teacher->name }}</option>
            @endforeach
          </select>
          @error('teacher_id')
            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
      ...
      <div
        ...
        <div>
          ...
          {{-- Note: Converting to H:i format for the time input --}}
      ...
      <div
        ...
        <div>
          ...
          <input type="date" id="join_start" name="join_start"
        ...
        <div>
          ...
          {{-- Note: Formatting the date for the HTML date input --}}
          <input type="date" id="join_end" name="join_end"

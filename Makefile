DEV_COMMAND := ./node_modules/.bin/concurrently --kill-others-on-fail -n "Backend,Frontend" -c "blue,green" "php artisan serve --port=8100" "npm run dev" "bash -c 'while true; do sleep 1; done'"

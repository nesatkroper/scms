...
<div id="Modalcreate" class="fixed inset-0 z-50 flex items-center justify-center p-4 hidden">
    <div
        ...
        <!-- Form Content -->
        <form action="{{ route('gradescales.store') }}" method="POST" class="py-4">
            @csrf
            ...
            <div class="h-[65vh] md:h-auto overflow-y-auto px-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-1 sm:gap-4 mb-2">
                    ...
                    <div class="mb-2">
                        ...
                        @error('name') border-red-500 @else border-gray-400 @enderror"
                            placeholder="Enter grade scale name (e.g., 'A', 'B', 'Pass')" required>
                    ...
                    <!-- GPA Field -->
                    <div class="mb-2">
                        <label for="gpa" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                            GPA Value <span class="text-red-500">*</span>
                        </label>
                        <input type="number" step="0.01" id="gpa" name="gpa" value="{{ old('gpa') }}"
                            class="w-full px-3 py-2 border rounded-md focus:outline focus:outline-white
                        focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white
                        @error('gpa') border-red-500 @else border-gray-400 @enderror"
                            placeholder="Enter GPA value (e.g., 4.0)" min="0" max="4" required>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-1 sm:gap-4 mb-2">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="number" step="0.01" id="min_percentage" name="min_percentage"
                            value="{{ old('min_percentage') }}"
                            class="w-full px-3 py-2 border rounded-md focus:outline focus:outline-white
                        focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white
                        @error('min_percentage') border-red-500 @else border-gray-400 @enderror"
                            placeholder="Enter minimum percentage" min="0" max="100" required>
                    ...
                    <div class="mb-2">
                        ...
                        <input type="number" step="0.01" id="max_percentage" name="max_percentage"
                            value="{{ old('max_percentage') }}"
                            class="w-full px-3 py-2 border rounded-md focus:outline focus:outline-white
                        focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white
                        @error('max_percentage') border-red-500 @else border-gray-400 @enderror"
                            placeholder="Enter maximum percentage" min="0" max="100" required>
                ...
                <div class="mb-2">
                    ...
                    @error('description') border-red-500 @else border-gray-400 @enderror"
                        placeholder="Enter grade scale description">{{ old('description') }}</textarea>

...
@section('content')
  ...
  <div
    ...
    {{-- Form action updated to the department store route --}}
    <form action="{{ route('admin.departments.store') }}" method="POST" id="createForm" class="p-0">
      @csrf

      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">

        {{-- Department Name Field --}}
        <div class="md:col-span-2"> {{-- Use full width on all screen sizes --}}
        ...
        {{-- Removed 'Code', 'Department Select', and 'Credit Hours' fields --}}
      ...
      <div class="flex justify-end space-x-3 pt-4 border-t border-gray-200 dark:border-gray-700">
        {{-- Cancel button updated to department index route --}}
        <a href="{{ route('admin.departments.index') }}"
        ...
        {{-- Submit button text and route updated --}}
        <button type="submit"

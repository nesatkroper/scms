          ...
          <div class="grid grid-cols-1 md::grid-cols-2 lg:grid-cols-3 gap-y-2 gap-x-6">
            ...
            {{-- <div class="mb-2">
              ...
              <input type="date" id="date_of_birth" name="date_of_birth" placeholder="Enter Date of Birth"
                value="{{ old('date_of_birth') }}" min="{{ now()->toDateString() }}" class="form-control w-full p-2 border px-4 rounded-lg focus:outline focus:outline-white
                         focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700
                         dark:border-gray-600 dark:text-white focus:bg-slate-100 dark:focus:bg-slate-700
            ...
            {{-- <div class="mb-2">
              ...
              <input type="date" id="admission_date" name="admission_date" value="{{ old('admission_date') }}" class="form-control w-full p-2 border px-4 rounded-lg focus:outline focus:outline-white
                         focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700
                         dark:border-gray-600 dark:text-white focus:bg-slate-100 dark:focus:bg-slate-700

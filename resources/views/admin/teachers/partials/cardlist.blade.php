...
@else
    <div class="col-span-full py-16 text-center">
        <div
            ...
            <h3 class="text-xl font-medium text-gray-800 dark:text-gray-200 mb-2">No Teachers Found</h3>
            <p class="text-gray-500 dark:text-gray-400 mb-4">Add your first teacher to get started</p>
        </div>
    </div>
@endif

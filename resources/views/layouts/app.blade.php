    ...
    <aside id="sidebar"
      ...
      <nav class="pt-4 flex-grow overflow-y-auto">
        ...
        <ul>
          ...
          <li class="menu-item relative">
            ...
            <div class="submenu">
              <ul class="pl-2 pr-2">
                ...
                <li class="relative">
                  <div class="cursor-pointer px-3 flex items-center justify-between py-2 hover:bg-indigo-700 dark:hover:bg-gray-700
                ...
                <li class="relative">
                  <a href="{{ route('payments.index') }}" class="flex items-center justify-between px-3 py-2 hover:bg-indigo-700
                                         dark:hover:bg-gray-700 rounded-lg transition-all duration-200">
                    <div class="flex items-center">
                      <i class="ri-money-dollar-circle-fill text-lg"></i>
            ...
            <div class="submenu">
              <ul class="pl-4 pr-4">
                <li class="relative">
                  ...
                  <div class="submenu">
                    <ul class="pl-4">
                      <li><a href="#" class="block py-2 hover:text-indigo-300 dark:hover:text-gray-300">All
                          Classes</a></li>
                      <li><a href="#" class="block py-2 hover:text-indigo-300 dark:hover:text-gray-300">Class
                          Sections</a></li>
                      <li><a href="#" class="block py-2 hover:text-indigo-300 dark:hover:text-gray-300">Class
                          Teachers</a></li>
                    </ul>
                ...
                <li class="relative">
                  ...
                  <div class="submenu">
                    <ul class="pl-4">
                      ...
                      <li><a href="#" class="block py-2 hover:text-indigo-300 dark:hover:text-gray-300">Assign
                          Teachers</a>
                      </li>
                    </ul>
                  </div>
                ...
                <li class="relative">
                  ...
                  <div class="submenu">
                    <ul class="pl-4">
                      <li><a href="#" class="block py-2 hover:text-indigo-300 dark:hover:text-gray-300">Class
                          Timetable</a></li>
                      <li><a href="#" class="block py-2 hover:text-indigo-300 dark:hover:text-gray-300">Teacher
                          Timetable</a></li>
                      <li><a href="#" class="block py-2 hover:text-indigo-300 dark:hover:text-gray-300">Generate
                          Timetable</a></li>
                    </ul>
                  </div>
                </li>
          ...
          <!-- Library -->
          <li class="menu-item relative">
            <div class="flex items-center justify-between px-4 py-3 hover:bg-indigo-700 dark:hover:bg-gray-700 rounded-lg mx-2 cursor-pointer
            ...
            <div class="submenu">
              <ul class="pl-2 pr-2">
                <li>
                  <a href="{{ route('books.index') }}" class="flex items-center justify-between px-4 py-2 hover:bg-indigo-700
                                         dark:hover:bg-gray-700 rounded-lg transition-all duration-200">
                    <div class="flex items-center">
                ...
                <li>
                  <a href="{{ route('admin.bookissues.index') }}" class="flex items-center justify-between px-4 py-2 hover:bg-indigo-700
                ...
                <li>
                  <a href="#" class="block px-4 py-2 hover:bg-indigo-700 dark:hover:bg-gray-700 rounded-md">
                    Books Inventory
                  </a>
                </li>
                <li>
          ...
          <li class="menu-item relative">
            ...
            <div class="submenu">
              <ul class="pl-2 pr-2">
                ...
                <li class="relative">
                  <a href="{{ route('expenses.index') }}" class="flex items-center justify-between px-3 py-2 hover:bg-indigo-700
                                         dark:hover:bg-gray-700 rounded-lg transition-all duration-200">
                    <div class="flex items-center">
                      <i class="ri-money-dollar-circle-fill text-lg"></i>
                ...
                <li class="relative">
                  <a href="{{ route('fee-structures.index') }}" class="flex items-center justify-between px-3 py-2 hover:bg-indigo-700
                                         dark:hover:bg-gray-700 rounded-lg transition-all duration-200">
                    <div class="flex items-center">
                      <i class="ri-book-2-fill text-lg"></i>

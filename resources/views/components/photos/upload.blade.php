<div class="absolute -bottom-12">
    <div
        ...
        <img id="{{$edit ? "edit_$name" : $name}}" src="" alt="" class="w-full h-full object-cover rounded-full">
        ...
        <input type="file" id="{{$edit ? "upload_$name" : "$name"}}" name="{{ $name }}" accept="image/*" class="hidden">

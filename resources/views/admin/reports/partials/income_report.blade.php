...
<div class="overflow-x-auto shadow-md sm:rounded-lg">
  <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
    ...
    <tbody>
      @forelse($data['list'] ?? [] as $index => $fee)
        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
          ...
          <th scope="row" class="px-6 py-2 font-medium text-green-600 whitespace-nowrap dark:text-green-400">
            {{ $fee->student->name ?? __('message.n/a') }}
          </th>
          <td class="px-6 py-2 text-lg font-bold text-green-700 dark:text-green-300">

...
@else
    <div class="col-span-full py-12 text-center">
        <div
            ...
            <h3 class="mt-4 text-lg font-medium text-red-400 dark:text-red-500">No Found data</h3>
            <p class="mt-1 text-sm text-red-400 dark:text-red-500">Create your first data to get started</p>
        </div>
    </div>
@endif

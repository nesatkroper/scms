<table class="w-full text-sm text-left">
    <thead class="bg-gray-50 dark:bg-gray-700/50 text-xs text-gray-700 dark:text-gray-400 uppercase">
        <tr class="text-nowrap">
            ...
            <th scope="col" class="px-4 py-4">Approved by</th>
        ...
        @if (count($expenses) > 0)
            @foreach ($expenses as $expense)
                <tr
                    ...
                    <td class="px-4 py-2">{{ $expense->approver->name ?? 'N/A' }}</td>
                    <td class="px-4 py-2">{{ Str::limit($expense->description, 20) }}</td>
                        ...
                        <div class="relative">
                            ...
                            <div class="dropdown-menu hidden absolute w-auto right-0 z-10 mt-2 origin-top-right divide-y divide-gray-100 dark:divide-gray-700 rounded-md bg-white dark:bg-gray-800 shadow-lg ring-1 ring-black/5 dark:ring-gray-700 focus:outline-none"
                                ...
                                <div class="py-1" role="none">
                                    <a href="#" title="Edit Id({{ $expense->id }})"
                                    ...
                                    <a href="#" title="Details Id({{ $expense->id }})"
                                    ...
                                    <button href="#" title="Delete Id({{ $expense->id }})"
                ...
                <td colspan="12" class="p-4 text-center">
                    <div class="col-span-full py-12 text-center">
                        <div
                            ...
                            <p class="mt-1 text-sm text-red-400 dark:text-red-500">Create your first expense to get
                                started</p>
                        </div>
                    </div>
                </td>
...
<!-- Bulk Actions Bar (add this below your table) -->

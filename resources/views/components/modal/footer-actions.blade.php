<div
  ...
  @if ($delete)
    <button type="button" id="cancelDeleteModal"
      class="p-2 border cursor-pointer border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700">
      {{ __('message.cancel') }}
    </button>
    <form id="Formdelete" method="POST">
      ...
      <button type="submit" id="confirmDeleteBtn"
        class="p-2 cursor-pointer bg-red-600 text-white rounded-lg hover:bg-red-700 flex items-center gap-2">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
          <path fill-rule="evenodd"

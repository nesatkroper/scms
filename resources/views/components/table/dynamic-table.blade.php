                ...
                <td colspan="{{ count($headers) + ($actions ? 1 : 0) + ($checkbox ? 1 : 0) }}" class="p-4 text-center">
                    <div class="col-span-full py-12 text-center">
                        <div
                            ...
                            <h3 class="mt-4 text-lg font-medium text-red-500 dark:text-red-500">No Records Found</h3>
                            <p class="mt-2 text-sm text-red-500 dark:text-red-500">{{ $emptyMessage }}</p>
                        </div>
                    </div>
                </td>
            </tr>

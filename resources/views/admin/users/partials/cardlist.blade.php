    ...
    <div
      ...
      <div class="px-4 py-2 bg-slate-50 dark:bg-slate-700 border-b border-gray-100 dark:border-slate-700">
        <div class="flex justify-between items-start gap-2">
          <div>
            <h4 class="font-bold capitalize text-lg text-gray-800 dark:text-gray-200">{{ $user->name }}</h4>
          ...
          <div class="p-2 rounded-lg bg-blue-50 dark:bg-slate-700 text-blue-600 dark:text-blue-300">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
              ...
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                d="M17 20h-2v-2a4 4 0 00-8 0v2H7a2 2 0 01-2-2V9a2 2 0 012-2h10a2 2 0 012 2v9a2 2 0 01-2 2zM9 13h6" />
            </svg>
          </div>
          <div>
            <p class="text-xs text-gray-500 dark:text-gray-400">User Type</p>
            <p class="font-medium text-gray-700 dark:text-gray-200">
              <span class="text-sm text-indigo-600 dark:text-indigo-400">{{ ucfirst($user->type) }}</span>
            </p>
          </div>
        </div>
...
@else
  <div class="col-span-full py-12 text-center">
    <div
      ...
      <p class="mt-1 text-sm text-red-500 dark:text-red-500">Create your first user to get started</p>
    </div>
  </div>
@endif

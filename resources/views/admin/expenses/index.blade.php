            ...
            @forelse($expenses as $expense)
                <div
                    ...
                    <div class="p-4 space-y-2 text-sm text-gray-700 dark:text-gray-300">
                        {{-- Date & Creator --}}
                        <div
                            class="flex justify-between items-center pb-2 border-b border-gray-100 dark:border-gray-700/50">
                        ...
                        @if ($expense->description)
                            <div class="pt-2 border-t border-gray-100 dark:border-gray-700/50">
                                ...
                                <p
                                    class="text-xs italic text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-700 p-2 rounded-md">

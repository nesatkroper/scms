<div class="mb-2">
                ...
                <div class="options-container">
                    @if ($options instanceof \Illuminate\Support\Collection)
                        @foreach ($options as $option)
                            <div class="{{ old($name, $value) == $option->name ? 'selected' : '' }}
    ...
    <p id="{{$edit ? "edit-error-$name" : "error-$name"}}" class="{{$edit ? "edit-error-$name" : "error-$name"}} mt-1 text-sm text-red-600 dark:text-red-500"></p>

  ...
  <div
    ...
    <div class="flex justify-between mb-4 items-center">
      <h3 class="text-xl mb-3 font-bold text-gray-800 dark:text-gray-200 flex items-center gap-2">
        ...
        {{ __('message.attendance') }} {{ __('message.history_for') }}: <span
    ...
    <h4 class="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">{{ __('message.attendance') }}
      {{ __('message.records') }}</h4>

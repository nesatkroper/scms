  ...
  <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}">
    ...
    <div class="flex gap-2 items-center justify-between sm:hidden">
      ...
      @if ($paginator->onFirstPage())
        <span
          class="inline-flex items-center p-2 text-sm font-medium text-gray-600 bg-white border border-gray-300 cursor-not-allowed leading-5 rounded-lg dark:text-gray-300 dark:bg-gray-700 dark:border-gray-600">

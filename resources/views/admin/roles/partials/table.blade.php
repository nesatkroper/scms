<table class="w-full text-sm text-left">
  <thead class="bg-gray-50 dark:bg-gray-700/50 text-xs text-gray-700 dark:text-gray-400 uppercase">
    <tr class="text-nowrap">
      ...
      <th scope="col" class="px-4 py-4">Role Name</th>
    ...
    @if (count($roles) > 0)
      @foreach ($roles as $role)
        <tr class="text-nowrap border-b border-gray-200 dark:border-gray-700 hover:bg-indigo-50 dark:hover:bg-gray-700">
          ...
          <td class="px-4 py-2">{{ $role->created_at->format('Y-m-d H:i:s') }}</td>
          <td class="px-4 py-2">{{ $role->updated_at->format('Y-m-d H:i:s') }}</td>
            ...
            <div class="relative">
              ...
              <div
                ...
                <div class="py-1" role="none">
                  ...
                  {{-- The 'Details' button is typically not needed for simple roles, so it's removed for brevity. --}}
                  <button href="#" title="Delete Id({{ $role->id }})"
        ...
        <td colspan="5" class="p-4 text-center">
          <div class="col-span-full py-12 text-center">
            <div
              ...
              <p class="mt-2 text-sm text-red-500 dark:text-red-500">Create your first role to get started
              </p>
            </div>
          </div>
        </td>
